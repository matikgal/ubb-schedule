...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden text-main font-sans transition-colors duration-300">
      ...
      {/* Main Content */}
      <main className="relative z-10 pt-28 pb-32 px-5 max-w-lg mx-auto md:max-w-2xl">
        {children}
      </main>
        ...
        <div className="glass-nav rounded-2xl p-1.5 flex items-center justify-between shadow-2xl">
          {navItems.map((item) => {
             ...
             return (
              ...
              >
                 <div className={`w-[80%] h-full rounded-xl flex items-center justify-center transition-all duration-300 ${
                     isActive 
