             ...
             <div className="flex flex-col h-full p-6">
                ...
                <div className="mb-6 relative shrink-0">
                    <textarea
                        ...
                        className="w-full bg-black/20 border border-white/10 rounded-2xl p-4 pr-14 text-main placeholder:text-muted/50 focus:outline-none focus:bg-black/40 focus:border-primary/50 resize-none h-32 transition-all shadow-inner"
                    />
                    <button
